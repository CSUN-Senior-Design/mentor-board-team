...
export class Calendar extends Component {
    ...
    //     let filteredNonOccurences = this.state.data.filter(activity => (Date.parse(activity.StartTime)  > Date.parse(currentDate) && Date.parse(activity.StartTime) < Date.parse(searchEndDate)) && activity.RecurrenceRule === null && activity.Priority > 0);
